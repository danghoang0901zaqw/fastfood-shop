        ...
        <div class="flex flex-col justify-start items-start w-full space-y-9">
          <div class="flex justify-start flex-col items-start space-y-2">
            <button class="flex flex-row items-center text-gray-600 hover:text-gray-500 space-x-1">
             ...
             <Link to="/cart"> <p class="text-sm leading-none text-slate-900">Back</p></Link>
            </button>
            <p class="text-3xl text-slate-900 lg:text-4xl font-semibold leading-7 lg:leading-9 ">
              Checkout
            </p>
            <p class="text-base text-slate-900 leading-normal sm:leading-4">
              Home - Cart - Checkout
            </p>
          </div>

          <div class="flex flex-col xl:flex-row justify-center xl:justify-between space-y-6 xl:space-y-0 xl:space-x-6 w-full">
            <div class=" flex flex-col sm:flex-row xl:flex-col justify-center items-center bg-gray-100 bg-gradient-to-tr from-orange-500 to-amber-500  py-7 sm:py-0 xl:py-10 px-10 xl:w-full">
              <div class="flex flex-col justify-start items-start w-full space-y-4">
                <p class="text-xl text-white md:text-2xl leading-normal ">
                  Logitech K251
                </p>
                <p class="text-base text-white font-semibold leading-none">
                  $520.00
                </p>
              </div>
            ...
            <div class="p-8 bg-gray-100 bg-gradient-to-tr from-orange-500 to-amber-500  flex flex-col lg:w-full xl:w-3/5">
              ...
              <div class="flex flex-row justify-center items-center mt-6">
                ...
                <p class="flex flex-shrink-0 px-4 text-base leading-4 text-gray-600">
                  or pay with card
                </p>
                <hr class="border w-full" />
              </div>
              ...
              <label class="mt-8 text-base leading-4 ">
                Card details
              </label>
