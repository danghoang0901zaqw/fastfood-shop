          ...
          <div class="-mx-4 flex flex-wrap lg:justify-between">
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div class="mb-12 max-w-[570px] lg:mb-0">
                <span class="text-orange-600 mb-4 block text-base font-semibold">
                  Contact Us
                </span>
                ...
                <div class="mb-8 flex w-full max-w-[370px]">
                  <div class="bg-orange-600 text-orange-600 mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-body-color text-base">
                      BH City, Nguyễn Hoàng 31/4, Việt Nam
                    </p>
                  </div>
                </div>
                <div class="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-body-color text-base">(+84) 348 240 175</p>
                  </div>
                </div>
                <div class="mb-8 flex w-full max-w-[370px]">
                  <div class="bg-orange-600 text-orange-600 mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-opacity-5 sm:h-[70px] sm:max-w-[70px]">
                ...
                <form>
                  <div class="mb-6">
                    <input
                      ...
                      class="text-body-color border-[f0f0f0] focus:border-orange-600 w-full rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                    />
                  </div>
                  <div class="mb-6">
                    <input
                  ...
                  <div class="mb-6">
                    <textarea
                      ...
                      class="text-body-color border-[f0f0f0] focus:border-orange-600 w-full resize-none rounded border py-3 px-[14px] text-base outline-none focus-visible:shadow-none"
                    ></textarea>
                  </div>
                  <div>
                    <button
                      type="submit"
                      class="bg-orange-600 border-orange-600 w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
